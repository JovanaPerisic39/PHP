                ...
                <form method="post" action="">
                    ...
                    <select id="poslastica" name="poslastica" class="form-control">
                        ...
                        foreach ($poslastice as $poslastica){
                            ?>
                        <option value="<?= $poslastica->id ?>"><?= $poslastica->naziv . " " ?></option>
                        <?php
                        }
                        ?>
                    </select>
                    <hr/>
                    <button type="submit" style="border-radius: 40px; border: 1px solid grey; background-color: rgb(221, 203, 217)" name="obrisi">Obrisi</button>
